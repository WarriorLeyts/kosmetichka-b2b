      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
        <div className="w-full max-w-md rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            {/* ─── Согласие с политикой и соглашением ──────────── */}
            <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <div
                  className={`h-5 w-5 rounded-md border-2 flex items-center justify-center transition-colors ${
                    consentChecked
                      ...
                      : "border-slate-300 bg-white group-hover:border-pink-300"
                  }`}
                >
                  {consentChecked && (
              ...
              <span className="text-xs text-slate-500 leading-relaxed">
                ...
                <Link href="/agreement" target="_blank" className="text-pink-500 hover:underline font-semibold">
                  Пользовательского соглашения
                </Link>{" "}
                и даю согласие на обработку персональных данных в соответствии с{" "}
                <Link href="/privacy" target="_blank" className="text-pink-500 hover:underline font-semibold">
            ...
            <button
              type="submit"
              disabled={loading || !captchaToken || !smsSent || smsCode.length < 4 || !consentChecked}
