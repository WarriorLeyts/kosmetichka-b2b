...
export default async function CustomerInvoicePage({
  ...
  return (
    <>
      ...
      {/* Toolbar */}
      <div className="no-print flex items-center gap-3 bg-white border-b px-6 py-3 shadow-sm sticky top-0 z-10">
        <a
          href="/orders"
      ...
      {/* Invoice */}
      <div
        className="invoice-wrap mx-auto my-8 max-w-3xl rounded-2xl bg-white px-10 py-10 shadow-lg print:my-0 print:max-w-none print:shadow-none"
      ...
      >
        ...
        <div className="mt-10 border-t pt-6 text-center text-xs text-slate-400">
          Счёт сформирован автоматически · kosmetichka-opt.ru
        </div>
      </div>
    </>
  );
